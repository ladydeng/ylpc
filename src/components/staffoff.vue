 ...
 * @version: v1.1.0
 * @author: Bai
 * @date: 2021年1月11日 上午9:45:17
 *
 * Modification History:<br>
 * Date             Author          Version            Description
 *---------------------------------------------------------*<br>
 * 2020年1月11日     Bai           v1.0.0              新建<br>
 */
 ...
 * @version: v1.0.0
 * @author: Bai
 * @date: 2021年1月11日 上午10:28:46
 *
 * Modification History:<br>
 * Date              Author          Version            Description
 *----------------------------------------------------------------*<br>
 * 2021年1月11日      Bai             v1.0.0            新建<br>
 */
export default {
  /**
   * name:组件名称
  ...
  created() {
    ...
    axios
      ...
      /** 利用反向代理访问地址 **/
      .post("/api/findAllPositionStatus",'positionStatus=离职')
